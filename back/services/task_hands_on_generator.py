...
10. **references (参考資料) 📚 重要: 日本語ドキュメント優先**
    - **公式ドキュメント**: 使用する技術の公式ドキュメントURL
      - **日本語版がある場合は必ず日本語版を優先** (例: React日本語ドキュメント, Next.js日本語ドキュメント)
      - 日本語版がない場合は英語公式を使用
    - **入門チュートリアル**: 初心者向けのチュートリアル記事
      - Zenn, Qiita, 公式チュートリアルなど信頼性の高い日本語記事を優先
      - 技術の基礎から学べる記事を選定
    - **関連リソース**: 実装に役立つ追加資料
      - GitHub リポジトリ例, サンプルコード集など
    - フォーマット例:
      ```
      - React 公式ドキュメント (日本語): https://ja.react.dev/
      - Next.js 公式チュートリアル: https://nextjs.org/learn
      - 【入門】React Hooks 徹底解説 (Zenn): https://zenn.dev/...
      ```

11. **estimated_time_minutes (推定時間)**
    - 実装にかかる現実的な時間を分単位で
