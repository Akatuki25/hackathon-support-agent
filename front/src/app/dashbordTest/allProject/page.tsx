...
import { Calendar, Users, Lightbulb, Clock, Plus, Search, Filter } from 'lucide-react';
...
export default function AllProjectPage() {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            case "進行中":
                return darkMode ? "text-green-400 border-green-400/50" : "text-green-600 border-green-500/50";
            case "完了":
                return darkMode ? "text-blue-400 border-blue-400/50" : "text-blue-600 border-blue-500/50";
            case "準備中":
                return darkMode ? "text-yellow-400 border-yellow-400/50" : "text-yellow-600 border-yellow-500/50";
            default:
                return darkMode ? "text-gray-400 border-gray-400/50" : "text-gray-600 border-gray-500/50";
        }
    };
    ...
    if (loading) {
        return (
            <div className={`min-h-screen flex items-center justify-center ${
                ...
                <div className={`relative px-8 py-6 rounded-lg backdrop-blur-sm border ${
                    darkMode 
                    ...
                    <div className={`absolute inset-0 ${
                        darkMode ? 'bg-gradient-to-r from-transparent via-cyan-400/10 to-transparent' : 'bg-gradient-to-r from-transparent via-purple-400/10 to-transparent'
                    } translate-x-[-100%] animate-pulse`}></div>
                    <div className="flex items-center space-x-4 relative">
                        <div className={`animate-spin rounded-full h-6 w-6 border-2 ${
                            darkMode ? 'border-cyan-400 border-t-transparent' : 'border-purple-600 border-t-transparent'
                        }`}></div>
                        <span className="text-lg font-mono font-bold tracking-wider">LOADING_PROJECTS...</span>
                    </div>
                </div>
            </div>
        );
        ...
        <div className={`min-h-screen p-6 ${
            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <h1 className={`text-4xl md:text-5xl font-bold font-mono tracking-wider mb-4 ${
                        darkMode 
                    ...
                    <div className="flex items-center justify-center mb-8">
                        <div className={`h-px w-16 ${darkMode ? 'bg-cyan-500' : 'bg-purple-500'}`}></div>
                        <div className={`mx-4 w-2 h-2 border ${darkMode ? 'border-cyan-500' : 'border-purple-500'} rotate-45`}></div>
                        <div className={`h-px w-16 ${darkMode ? 'bg-pink-500' : 'bg-blue-500'}`}></div>
                    </div>
                </div>
                ...
                {filteredProjects.length === 0 ? (
                    <div className={`text-center p-12 rounded-lg backdrop-blur-sm border ${
                        darkMode 
                            ? 'bg-gray-900/50 border-cyan-500/30' 
                            : 'bg-white/50 border-purple-300/30'
                    }`}>
                        <div className={`w-20 h-20 mx-auto mb-6 rounded-full border-2 flex items-center justify-center ${
                            darkMode ? 'border-cyan-500/50 text-cyan-400' : 'border-purple-500/50 text-purple-600'
                        }`}>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute top-4 right-4 flex items-center space-x-2">
                                        <div className={`px-2 py-1 rounded text-xs font-mono font-bold border ${statusColor}`}>
                                            {status}
                                        </div>
                                    ...
                                    <div className="relative">
                                        {/* Title */}
                                        <h2 className={`text-xl font-bold mb-4 font-mono tracking-wider line-clamp-2 pr-20 ${
                                            darkMode ? 'text-white' : 'text-gray-900'
                                        }`}>
