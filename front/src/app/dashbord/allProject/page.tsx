...
import { Lightbulb, Clock, Search, Plus, Trash2 } from "lucide-react";
    ...
    <>
      ...
      <div className="min-h-screen pt-24 p-6 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-black dark:to-gray-900">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-block px-4 py-2 rounded-lg font-mono text-sm mb-6 backdrop-blur-md bg-purple-500/10 text-purple-600 border border-purple-300/30 dark:bg-cyan-500/10 dark:text-cyan-400 dark:border-cyan-500/30">
          ...
          {filteredProjects.length === 0 ? (
            <div className="text-center p-12 rounded-lg backdrop-blur-xl border bg-white/60 border-purple-300/30 dark:bg-gray-800/30 dark:border-cyan-500/30 dark:shadow-lg dark:shadow-cyan-500/20">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full border-2 flex items-center justify-center border-purple-500/50 text-purple-600 dark:border-cyan-500/50 dark:text-cyan-400">
                <Lightbulb className="w-10 h-10" />
              </div>
              <h3 className="text-2xl font-mono font-bold mb-3 text-gray-900 dark:text-white">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      {/* Title */}
                      <h2 className="text-xl font-bold mb-4 font-mono tracking-wider line-clamp-2 pr-20 text-gray-900 dark:text-white">
                      ...
                      <div className="mb-6">
                        <div className="flex items-center mb-2">
                          ...
                          <span className="text-xs font-mono font-bold text-purple-600 dark:text-cyan-400">
                            {/* PROJECT_CONCEPT */}
                          </span>
                        </div>
      ...
      {deleteModalOpen && projectToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative max-w-md w-full rounded-lg backdrop-blur-xl border shadow-2xl p-6 bg-white/90 border-red-500/50 shadow-red-300/30 dark:bg-gray-800/90 dark:border-red-500/50 dark:shadow-red-500/30">
            {/* Cyber corners */}
            <div className="absolute top-2 left-2 w-4 h-4 border-l-2 border-t-2 border-red-500/50 dark:border-red-400/50"></div>
            <div className="absolute bottom-2 right-2 w-4 h-4 border-r-2 border-b-2 border-red-500/50 dark:border-red-400/50"></div>

            {/* Warning Icon */}
            <div className="flex items-center justify-center mb-4">
              <div className="w-16 h-16 rounded-full border-2 flex items-center justify-center border-red-500/50 text-red-600 bg-red-50 dark:border-red-500/50 dark:text-red-400 dark:bg-red-500/10">
                <Trash2 className="w-8 h-8" />
              </div>
            </div>

            {/* Title */}
            <h2 className="text-xl font-bold font-mono text-center mb-2 text-gray-900 dark:text-white">
            ...
            {/* Confirmation Input */}
            <div className="mb-6">
              <label className="block text-sm font-mono mb-2 text-gray-700 dark:text-gray-300">
                プロジェクト名を入力:
              </label>
              <input
                type="text"
