...
export const getProjectMember = async (
  ...
  const response = await axios.get<ProjectMemberType>(
    `${API_URL}/project_member/member/${projectMemberId}`,
  );
...
export const postProjectMember = async (
  ...
  const response = await axios.post<ProjectMemberResponseType>(
    `${API_URL}/project_member/member/`,
    projectMember,
  );
...
export const putProjectMember = async (
  ...
  const response = await axios.put<ProjectMemberResponseType>(
    `${API_URL}/project_member/member/${projectMemberId}`,
    projectMember,
  );
...
export const patchProjectMember = async (
  projectMemberId: string,
  projectMemberPatch: ProjectMemberPatch,
): Promise<string> => {
  const response = await axios.patch<ProjectMemberResponseType>(
    `${API_URL}/project_member/member/${projectMemberId}`,
    projectMemberPatch,
  );
  return response.data.message;
...
export const getProjectMembersByMemberId = async (
  memberId: string,
): Promise<ProjectMemberType[]> => {
  const response = await axios.get<ProjectMemberType[]>(
    `${API_URL}/project_member/by_member/${memberId}`,
  );
  return response.data;
};
