    ...
    >
      ...
      <div className="flex flex-col justify-center items-center py-16">
        ...
        <div className="relative w-24 h-24">
          {/* 回転する外側リング */}
          <div
            className="absolute inset-0 border-4 border-transparent border-t-purple-600 border-r-blue-500 dark:border-t-cyan-500 dark:border-r-pink-400 rounded-full animate-spin"
          ></div>

          {/* パルスする内側サークル */}
          <div
            className="absolute inset-3 bg-gray-100 dark:bg-gray-900 rounded-full flex items-center justify-center"
          >
            <div
              className="w-10 h-10 bg-purple-500/20 dark:bg-cyan-500/20 rounded-full animate-ping"
            ></div>
          </div>

          {/* 文字 */}
          <div
            className="absolute inset-0 flex items-center justify-center text-xs text-purple-700 dark:text-cyan-400 font-bold"
          >
            LOADING
          </div>
        </div>
        ...
        {/* ローディングテキスト */}
        <div
          className="mt-6 text-purple-700 dark:text-cyan-400 font-bold tracking-wider flex flex-col items-center"
        >
