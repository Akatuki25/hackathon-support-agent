...
import React from "react";
 ...
 const GridEdgesDark = () => {
    ...
    return(
        <div className={`min-h-screen font-mono transition-all duration-500 flex items-center justify-center bg-gray-900 relative overflow-hidden`}>
