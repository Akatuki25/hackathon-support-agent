...
import { LogIn, UserPlus, Terminal, Shield, Cpu, Settings, LogOut, ChevronDown } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 group">
              <div className={`relative w-12 h-12 rounded-lg ${
                ...
                <Terminal className="text-white font-bold text-lg relative z-10" size={24} />
                {/* Corner brackets */}
            ...
            <div className="flex items-center space-x-4">
              {status === "loading" && (
                <div className={`relative px-6 py-3 rounded-lg backdrop-blur-sm border ${
                  darkMode 
                  ...
                  <div className="flex items-center space-x-3 relative">
                    ...
                    <span className="text-sm font-mono font-bold tracking-wider">LOADING...</span>
                  </div>
                </div>
              )}
              ...
              {session && (
                <div className="flex items-center space-x-4 relative" ref={menuRef}>
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                        <img 
                          ...
                          className={`w-10 h-10 rounded-lg border-2 transition-all duration-300 ${
                            darkMode ? 'border-cyan-500/50 group-hover:border-cyan-400' : 'border-purple-500/50 group-hover:border-purple-400'
                          }`}
                        />
                        {/* Cyber frame */}
                        <div className={`absolute -inset-1 border transition-all duration-300 ${
                          darkMode ? 'border-cyan-400/30 group-hover:border-cyan-400/50' : 'border-purple-400/30 group-hover:border-purple-400/50'
                        } rounded-lg`}></div>
                      </div>
                      <div className="hidden sm:block">
                        <p className={`text-sm font-mono font-bold tracking-wider ${
                          ...
                          USER_{session.user?.name?.toUpperCase().replace(/\s+/g, '_')}
                        </p>
                  ...
                  {/* Dropdown Menu */}
                  {isMenuOpen && (
                    <div className={`absolute top-full right-0 mt-2 w-64 rounded-lg backdrop-blur-md border shadow-xl z-50 overflow-hidden ${
                      darkMode 
                      ...
                      <div className="py-2">
                        ...
                        >
                          ...
                          <div>
                            <span className="font-mono font-bold text-sm tracking-wider">SETTINGS</span>
                            <p className={`text-xs font-mono ${
                        ...
                        >
                          ...
                          <div>
                            <span className="font-mono font-bold text-sm tracking-wider">LOGOUT</span>
                            <p className={`text-xs font-mono ${
                              darkMode ? 'text-gray-500' : 'text-gray-400'
                            }`}>
                              // End session
                      ...
                      <div className={`px-4 py-2 border-t ${
                        darkMode ? 'border-cyan-500/20 bg-gray-800/50' : 'border-purple-300/20 bg-gray-50/50'
                      }`}>
