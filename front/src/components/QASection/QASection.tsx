  ...
  const handleAddNewQA = async () => {
    ...
    try {
      const newQA: Omit<QAType, "qa_id" | "created_at"> = {
        ...
        source_doc_id: null,
        follows_qa_id:
          questions.length > 0 ? questions[questions.length - 1].qa_id : null,
      };
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pr-2">
        ...
        {questions.length > 0 ? (
          questions.map((qa, index) => (
            <div
              key={qa.qa_id}
              className="p-3 rounded-lg border bg-purple-50/70 border-purple-300/50 dark:bg-gray-700/40 dark:border-cyan-500/30"
            >
                ...
                <div className="flex-1">
                  ...
                  editingQA.field === "question" ? (
                    ...
                    <label
                      ...
                      onClick={() =>
                        handleStartEdit(qa.qa_id, "question", qa.question)
                      }
                    >
              ...
              {editingQA?.id === qa.qa_id && editingQA.field === "answer" ? (
                ...
                <div
                  onClick={() =>
                    handleStartEdit(qa.qa_id, "answer", qa.answer || "")
                  }
